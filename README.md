# Kubernetes The Hard Way On VMware Fusion or Workstation

This repo is forked from mmumshad's Kubernetes the Hardway for Virtualbox, and modified to support VMware Fusion and Workstaiton. You must have the Vagrant Desktop driver in order to utilize the Vagrantfile. 
